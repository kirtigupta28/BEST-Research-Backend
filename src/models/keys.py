...
class Keys: 
    ...
    def create(self, data):
        ...
        """
        result = self.__collection__.insert_one(data)
    ...
    def get_by_user_id(self, user_id):
        ...
        """
        return self.__collection__.find_one({"user_id": user_id}, {"_id": 0})
...
def create_key():
    ...
    data = request.json
    if not data or "user_id" not in data or "key_data" not in data:
        return jsonify({"error": "Invalid request"}), 400

    key_id = keys_model.create(data)
